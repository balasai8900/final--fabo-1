...
public class ClientProductController {
	...
	public String filtersWithList(
	    ...
	    String userEmail = principal.getName(); // Retrieve the currently logged-in user's email

	    // Retrieve the user's store code based on their email
	    String userStoreCode = userService.getUserStoreCodeByEmail(userEmail); // Replace userService with your actual service
